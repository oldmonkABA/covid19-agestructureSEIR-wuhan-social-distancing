...
for sim = 1:nsim
  ...
  epi_doNothingDurInf3(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_nothing,...
   ...
   epi_baseDurInf3(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_base,...
    ...
    epi_marchDurInf3(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_march,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
    epi_aprilDurInf3(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_april,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
...
for sim = 1:nsim
  ...
  epi_doNothingDurInf7(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_nothing,...
                                                    pWorkOpen_nothing,dateStartSchoolClosure_nothing,....
                                                    dateStartIntenseIntervention_nothing,...
                                                    dateStart,POP,numWeekStagger_nothing,...
                                                    pInfected,durInf,contacts_china);
   epi_baseDurInf7(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_base,...
                                               pWorkOpen_base,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_base,pInfected,durInf,contacts_china);
    epi_marchDurInf7(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_march,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
    epi_aprilDurInf7(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_april,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
...
for sim = 1:nsim
  ...
  epi_doNothingDurInf3I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_nothing,...
                                                    pWorkOpen_nothing,dateStartSchoolClosure_nothing,....
                                                    dateStartIntenseIntervention_nothing,...
                                                    dateStart,POP,numWeekStagger_nothing,...
                                                    pInfected,durInf,contacts_china);
   epi_baseDurInf3I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_base,...
                                               pWorkOpen_base,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_base,pInfected,durInf,contacts_china);
    epi_marchDurInf3I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_march,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
    epi_aprilDurInf3I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_april,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
...
for sim = 1:nsim
  ...
  epi_doNothingDurInf7I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_nothing,...
                                                    pWorkOpen_nothing,dateStartSchoolClosure_nothing,....
                                                    dateStartIntenseIntervention_nothing,...
                                                    dateStart,POP,numWeekStagger_nothing,...
                                                    pInfected,durInf,contacts_china);
   epi_baseDurInf7I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_base,...
                                               pWorkOpen_base,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_base,pInfected,durInf,contacts_china);
    epi_marchDurInf7I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_march,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
    epi_aprilDurInf7I2000(sim) = simulateOutbreakSEIR(R0est(sim),rho,R0tpostoutbreak,dateEndIntenseIntervention_april,...
                                                    pWorkOpen_default,dateStartSchoolClosure_default,....
                                                    dateStartIntenseIntervention_default,...
                                                    dateStart,...
                                                    POP,numWeekStagger_default,pInfected,durInf,contacts_china);
